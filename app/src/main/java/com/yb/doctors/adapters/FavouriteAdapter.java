...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.ViewHolder> {
    ...
    public FavouriteAdapter(List<Doctor> doctors){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView nameTextView,specialtyTextView,cityTextView;
        ...
        public ViewHolder(View itemView) {
            ...
            nameTextView = itemView.findViewById(R.id.item_favourite_name);
            specialtyTextView = itemView.findViewById(R.id.item_favourite_specialty);
            cityTextView = itemView.findViewById(R.id.item_favourite_city);
        }
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.cityTextView.setText("Baghdad");
